...
public class ConstantValues {
    public static final String URL_LOGIN = "http://movil.ventascloud.cl/sesion.php?";
    public static final String URL_LISTA_CATEGORIA_GASTO = "http://movil.ventascloud.cl/ConsultarListaCategoriaG.php?id=";
    ...
    public static final String URL_REGISTRO_USUARIO = "http://movil.ventascloud.cl/registrar.php?";
